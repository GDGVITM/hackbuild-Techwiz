        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Designed specifically for students to kickstart their freelance careers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Projects designed for students with flexible schedules and learning opportunities
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Earn While Learning</h3>
              <p className="text-gray-600">
                Get paid for your skills while gaining real-world experience and building your portfolio
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Quick project matching and secure payment processing to protect both students and businesses
              </p>
            </div>
          </div>
        </div>
